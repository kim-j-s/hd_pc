	...
	t(document).on("mouseup", function () {
		...
		t.ui.plugin.add("resizable", "containment", {
			...
			stop: function () {
				...
				e._helper && !i.animate && /relative/.test(o.css("position")) && t(this).css({ left: r.left - n.left - s.left, width: h, height: l }), e._helper && !i.animate && /conts/.test(o.css("position")) && t(this).css({ left: r.left - n.left - s.left, width: h, height: l });
			},
		}),
